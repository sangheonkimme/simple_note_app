...
import 'package:novita/src/data/repositories/api_sync_repository.dart';
...
final syncRepositoryProvider = Provider<SyncRepository>((ref) {
  ...
  return ApiSyncRepository(dio: dio);
});
...
final syncServiceProvider = Provider<SyncService>((ref) {
  ...
  return SyncService(isar, syncRepository, tokenStorage);
});
...
final favoriteNotesStreamProvider = StreamProvider<List<Note>>((ref) {
  final noteRepository = ref.watch(noteRepositoryProvider);
  return noteRepository.watchFavoriteNotes();
});

final archivedNotesStreamProvider = StreamProvider<List<Note>>((ref) {
  final noteRepository = ref.watch(noteRepositoryProvider);
  return noteRepository.watchArchivedNotes();
});

final deletedNotesStreamProvider = StreamProvider<List<Note>>((ref) {
  final noteRepository = ref.watch(noteRepositoryProvider);
  return noteRepository.watchDeletedNotes();
});
